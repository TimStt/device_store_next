...
import { useSubmitAddProduct } from "../../hooks/use-add-product";
import { useActionsAdd } from "../../hooks/use-actions-add";
    ...
    <FormikProvider value={formik}>
      <form className={style.root} onSubmit={formik.handleSubmit}>
        ...
        <div className={style.root__actions}>
          <Link href={paths.admin}>Назад</Link>
          <SubmitChange
            textButton="Добавить"
            icon={
              <PlusIcon className={style.root__icon} width={20} height={20} />
            }
          />
        </div>
      </form>
